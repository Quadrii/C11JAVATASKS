...
public class Mileage{
    public static void main(String[] arg){
        ...
        while (cont != 'n'){
            ...
            System.out.printf("Your MPG for this trip is %.2f: ", mileage.getTripMPG(miles, gallons));
            System.out.print("Do you want to add another trip? y/n");
            cont = input.next().charAt(0);
        }
        System.out.println("COMBINE TOTAL MPG");
        System.out.printf("Your total MPG for this trip is %.2f: ", mileage.getTotalMPG());
    }
}
